...
%We wish to model dependent types using category theory. In order to do this we will introduce some important category theory, give examples and illustrate how one might go about modelling depenent types. A model is a loose term used to describe the process of finding a mathematical structure, studying how it acts and using this to reason about your desired thing to study. This process can be made much more rigourous than described here, and discussion of the process is really an escipade of mathematical philosophy which we will gloss over for the sake of clarity.
