...
% Notes on statics and dynamics of STLC

% History and implications of curry howard
\input{curry.tex}

% STLC with sums, 0, and N
...
% Derive categorical semantics of STLC

% Modify STLC to accomadate for dependent types with guidance from Curry-Howard

% Sketch semantics of (essentially) LF

% Talk about dependent products, dependent sums, Martin-lofs calculi etc
...
\begin{appendices}
    ...
    \begin{landscape}
        ...
        \subsection{Currying $\lambda x . \lambda y . \lambda z . x (y, z)$} % Curry
            \input{ex8.tex} \label{ex8}
        \subsection{Uncurry}
            \input{ex9.tex} \label{ex9}
