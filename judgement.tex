...
\begin{lemma}[Transitivity]\tag{derivability_transitivity}
...
\begin{proof}
    By definition of admissibility we need to show that $\vdash_{\mathcal{R}} \Gamma$ implies $\vdash_{\mathcal{R}} J$. It can be seen that repeated applciation of transitivity allows us to form a similar statement for when $K$ is a context in reference to \ref{derivability_transitivity}. This repeated transitivity gives us the desired result.
\end{proof}
